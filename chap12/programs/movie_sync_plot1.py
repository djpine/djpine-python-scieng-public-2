...
framesDir = "movie_from_frames"  # movie frames directory
framesData = "movie_sync_data.csv"  # data file with intensities
...
ims = []
imagelist = sorted(glob(framesDir + "/sp00*.png"))
for i, fname in enumerate(imagelist):
    # print(i, fname)  # uncomment to follow loading of image frames
    if uv[i] >= blue[i]:
...
ani2.save("movies/movie_sync_plot1.mp4", extra_anim=[ani1],
