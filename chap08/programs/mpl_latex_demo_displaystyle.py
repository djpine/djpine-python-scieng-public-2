...
ax.text(0.45, 0.95,
        r'$\displaystyle \Gamma(z)=\int_0^\infty x^{z-1}e^{-x}dx$',
        fontsize=16, ha='right', va='top',
        transform=ax.transAxes)
ax.text(0.45, 0.75,
        r'$\displaystyle e^x=\sum_{n=0}^\infty\frac{x^n}{n!}$',
        fontsize=16, ha='right', va='top',
        transform=ax.transAxes)
ax.text(0.45, 0.55,
        r'$\displaystyle \zeta(z)=\prod_{k=0}^\infty \frac{1}{1-p_k^{-z}}$',
        fontsize=16, ha='left', va='top',
        transform=ax.transAxes)
ax.text(0.95, 0.80,
        r'$\displaystyle \omega={0:0.1f},\;\gamma={1:0.1f},\;\tau={2:0.1f}$'
        .format(omega, gamma, tau),
        fontsize=14, ha='right', va='top',
        transform=ax.transAxes)
ax.text(0.85, 0.35,
        r'$\displaystyle e=\lim_{n\to\infty}\left(1+\frac{1}{n}\right)^n$',
        fontsize=14, ha='right', va='top',
        transform=ax.transAxes)

fig.tight_layout()
fig.savefig('./figures/mplLatexDemoDisplaystyle.pdf')
plt.show()
